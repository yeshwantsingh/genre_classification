...
feature, dataset = 'tonnetz', 'ismir04'
...
def plot_history(history):
    ...
    plt.savefig('model1_tonnetz.png')
...
def main():
    ...
    model = build_model((X_train.shape[1], X_train.shape[2], X_train.shape[3]), 8)
    ...
    plot_model(model, show_shapes=True, to_file='model1_' + feature + '.png')
